    ...
    mkdir $topology
        ...
        do
            ...
            #sed -i s/\#load\#/${PERIODVALUES[i]}/ udp-sender.c
                ...
                mv "packets.dat" $topology"/emmac_"${PERIODVALUES[i]}"_iteration-"$j".dat"
                mv "COOJA.testlog" $topology"/emmac_testlog_"${PERIODVALUES[i]}"_iteration-"$j".txt"
                mv "COOJA.log" $topology"/emmac_log_"${PERIODVALUES[i]}"_iteration-"$j".txt"
            done 
            #rm udp-sender.c
        done
